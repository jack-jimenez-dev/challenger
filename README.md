...
A Spring Boot REST API that performs calculations with dynamic percentages and maintains a call history.

## Features

- **Dynamic Percentage Calculation**: Adds two numbers and applies a percentage obtained from an external service
- **Percentage Caching**: Caches the percentage for 30 minutes to improve performance
- **Asynchronous Call Logging**: Records all API calls without impacting performance
